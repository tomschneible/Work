...
- Correct Answer/Domain/Skill cells stay blank on the template itself --
  ...
  block at export time, never present here beforehand. Only their values
  are copied: every cell's formatting (font size included) is whatever
  this template itself sets.
